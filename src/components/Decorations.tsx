...
const Decorations = () => {
    const scrollToNextScreen = () => {
        ...
        const scrollDistance = isMobile ? window.innerHeight * 0.95 : window.innerHeight; // Scroll 75% of the viewport height for mobile, full height for desktop
        window.scrollBy({
            top: scrollDistance,
            behavior: 'smooth'
        });
    ...
    return (
        <>
            {/* Hero Section */}
            <div className="min-h-[calc(100vh-150px)] md:min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 flex flex-col relative overflow-hidden">
                {/* Decorative Elements */}
                    ...
                    <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between gap-12">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start space-y-6">
                            <div className="relative">
                                ...
                                {/* Logo Container */}
                                <div className="relative flex items-center space-x-4 bg-white bg-opacity-90 p-6 rounded-2xl shadow-xl">
                                    <Image
                                    ...
                                    />
                                    <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 text-transparent bg-clip-text">
                                        TaskFlow
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 w-full max-w-md mt-8">
                                <div className="bg-white bg-opacity-90 p-4 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-purple-100">
                                    <h3 className="font-semibold text-lg text-purple-600">Smart Organization</h3>
                                    <p className="text-gray-600">Sort your daily tasks smartly</p>
                                </div>
                                <div className="bg-white bg-opacity-90 p-4 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-purple-100">
                                    <h3 className="font-semibold text-lg text-blue-600">Real-time Sync</h3>
                                    <p className="text-gray-600">Access your tasks anywhere</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start space-y-8">
                            <div className="space-y-6 text-center md:text-left">
                                ...
                                <p className="text-xl text-gray-600 max-w-xl">
                                    Experience the future of task management with our intuitive and powerful todo list platform.
                                </p>
                            </div>
